...
//   const theme = {
//     background: darkMode 
//       ? 'linear-gradient(0deg, #0a1620 0%, #1a2a3a 100%)' 
//       : 'linear-gradient(0deg, rgba(20, 44, 61, 1) 0%, rgba(78, 144, 230, 1) 100%)',
//     bookBg: darkMode ? '#1e1e1e' : 'white',
//     textColor: darkMode ? '#f0f0f0' : '#333',
//     cardBg: darkMode ? '#2a2a2a' : 'white',
//     switchBg: darkMode ? '#00a6ff' : '#2a2a2a',
//     userProfileBg: darkMode ? 'rgba(46, 142, 255, 0.4)' : 'rgba(46, 142, 255, 0.2)',
//     userProfileHover: darkMode ? 'rgba(2, 60, 45, 1)' : 'rgba(2, 89, 64, 1)'
//   };
//   return (
...
//     {/* codigo de la tarjeta de la empresa */}
...
//       {/* Codigo del boton de modo oscuro o claro */}
...
const StyledWrapper = styled.div`
  ...
  /* Todos los demás estilos permanecen exactamente iguales */
  .social {
    display: flex;
    align-items: flex-end;
    align-self: flex-end;
